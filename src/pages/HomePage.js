      ...
      <div className="row">
        <div className="col-md-8">
          ...
          <p>
            ...
            Nulla urna massa, hendrerit in mollis ac, porta non neque. Cras nec
            tristique dolor, id efficitur nibh. Cras dui risus, dapibus eu
            blandit eget, malesuada ut libero. Aliquam mattis, nunc consectetur
            ultrices semper, lorem risus condimentum erat, non rhoncus odio
            ligula quis nibh. Nunc mattis cursus tortor, eu convallis erat
          </p>
        </div>
